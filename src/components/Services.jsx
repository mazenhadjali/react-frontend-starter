    ...
    const services = [
        {
            ...
            items: ["Market Research", "User Personas", "Roadmap Development"],
        },
        {
            icon: <PenTool className="h-6 w-6" />,
            title: "Design",
            description:
                "Beautiful, customer-centered designs that create engaging experiences across all platforms.",
        ...
        },
        {
            ...
            items: ["Customer Interface Dev", "BBackoffice Dev", "API Integration"],
        },
        {
            icon: <Shrub className="h-6 w-6" />,
            title: "Security",
            description: "Protecting your digital assets and ensuring compliance. Manage all permissions and access controls based on your preferred role.",
            items: ["Data Protection", "Access Control", "Compliance Management"],
        },
    ];
